  ...
  const renderFrameworkOverview = () => (
    <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-10 space-y-10 sm:space-y-12">
      ...
      <div className="text-center space-y-4 relative">
        ...
        <p className="text-xs sm:text-sm text-zinc-400 max-w-2xl mx-auto leading-relaxed pt-2 font-normal">
      ...
      <div className="space-y-5">
        <div className="text-center sm:text-left border-b border-zinc-800 pb-3">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {/* Step 1 */}
          <div className="p-5 rounded-2xl bg-[#0D0B14] border border-zinc-800 space-y-2 group">
          ...
          <div className="md:col-span-2 p-5 sm:p-6 rounded-2xl bg-[#0D0B14] border border-zinc-800 space-y-2 group">
            <div className="flex items-center justify-between">
              <span className="text-[10px] font-mono uppercase tracking-wider text-zinc-400 font-semibold">
                STEP 05 • FINAL ASSEMBLY
              </span>
              <Wand2 size={18} className="text-zinc-400" />
            </div>
            <h3 className="text-base font-bold text-white font-nohemi">Generate the prompt</h3>
            <p className="text-xs sm:text-[13px] text-zinc-400 leading-relaxed font-normal max-w-2xl">
      ...
      <div className="p-6 sm:p-8 rounded-2xl bg-[#0D0B14] border border-zinc-800 space-y-6">
        ...
        {/* Highlight Result Formula */}
        <div className="p-4 sm:p-5 rounded-xl bg-zinc-900 border border-zinc-800 text-center">
          <p className="text-xs sm:text-sm md:text-base font-bold text-white tracking-wide flex items-center justify-center flex-wrap gap-2">
            ...
            <span className="text-zinc-500 font-black text-base">→</span>
            <span className="text-white font-extrabold">stronger copy</span>.
          </p>
        </div>
      </div>

      {/* 4. SECTION: ONE CLICK. STRAIGHT INTO MURGII */}
      <div className="p-6 sm:p-8 rounded-2xl bg-[#0D0B14] border border-zinc-800 space-y-4">
      ...
      <div className="p-6 sm:p-10 rounded-2xl bg-[#0D0B14] border border-zinc-800 text-center space-y-6 relative overflow-hidden">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-2">
          {hasAccess ? (
            <button
              ...
              className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3 rounded-xl bg-white hover:bg-zinc-200 text-black font-extrabold text-xs sm:text-sm uppercase tracking-wider transition-all cursor-pointer group"
            >
              <span>Build a Custom Prompt</span>
          ...
          <button
            type="button"
            onClick={onGoToChat}
            className="w-full sm:w-auto px-6 py-3 rounded-xl bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-xs sm:text-sm font-bold text-zinc-300 hover:text-white transition-all cursor-pointer"
          >
            Return to Workspace
          </button>
        </div>
  ...
  if (!hasAccess) {
    return (
      <div className="flex-1 flex flex-col relative overflow-hidden font-sans h-full min-h-0 bg-[#07060B] text-white">
        {/* Section Top Header */}
        <div className="mt-6 sm:mt-8 mx-4 sm:mx-6 mb-2 p-4 sm:px-6 sm:py-4 rounded-2xl border border-zinc-800 flex flex-col sm:flex-row sm:items-center justify-between gap-3 relative z-10 bg-[#0D0B14]">
          <div className="flex items-center gap-3">
            <Wand2 size={20} className="text-zinc-400 shrink-0" />
            <div>
              ...
              <p className="text-xs text-zinc-400 font-medium">Turn a rough idea into a prompt built to perform</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 self-start sm:self-auto flex-wrap">
            {onGoToLanding && (
              <button
                ...
                className="text-xs font-semibold text-zinc-400 hover:text-white px-3 py-1.5 rounded-xl bg-zinc-900 border border-zinc-800 transition-colors cursor-pointer flex items-center gap-1.5"
              >
                <ArrowLeft size={13} />
                <span>Home</span>
              </button>
            ...
            {onGoToPricing ? (
              <button
                type="button"
                onClick={onGoToPricing}
                className="text-xs font-bold text-black px-3.5 py-2 rounded-xl bg-white hover:bg-zinc-200 transition-all flex items-center gap-1.5 cursor-pointer"
              >
                <span>Upgrade</span>
                <Sparkles size={12} />
              </button>
            ...
            <button
              type="button"
              onClick={onGoToChat}
              className="text-xs font-semibold text-zinc-300 hover:text-white px-3.5 py-2 rounded-xl bg-zinc-900 border border-zinc-800 transition-colors cursor-pointer"
            >
              Go to Workspace
            </button>
          </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              <span className="hidden sm:inline-block text-[10px] font-mono uppercase tracking-wider text-zinc-400 font-semibold">
                Core &amp; Max
              </span>
            </div>
        ...
        <div className="flex items-center gap-2 flex-wrap">
          ...
          {viewMode === "builder" && (
            <button
              type="button"
              onClick={handleReset}
              className="p-2 sm:px-3 sm:py-1.5 rounded-xl bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-xs font-semibold text-zinc-400 hover:text-white flex items-center gap-1.5 transition-all cursor-pointer"
          ...
          <button
            type="button"
            onClick={onGoToChat}
            className="px-3.5 py-1.5 rounded-xl bg-white hover:bg-zinc-200 text-xs font-bold text-black transition-all cursor-pointer"
          >
            Chat Workspace
          </button>
        </div>
        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8 relative z-10 custom-scrollbar">
          <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8 pb-12">
            ...
            <div className="lg:col-span-5 space-y-5">
              <div className="p-5 sm:p-6 rounded-2xl bg-[#0D0B14] border border-zinc-800 space-y-5">
                      ...
                      return (
                        ...
                        >
                          <div className="flex items-center gap-2 mb-1">
                            ...
                            <span className={`text-xs font-bold ${isSelected ? "text-black" : "text-zinc-300"}`}>
                              {cat.label}
                            </span>
                          </div>
                          <p className={`text-[10px] line-clamp-1 ${isSelected ? "text-zinc-700 font-medium" : "text-zinc-500"}`}>
                            {cat.desc}
                          </p>
                        </button>
                      );
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3.5 py-2.5 rounded-xl bg-zinc-900 border border-zinc-800 focus:border-zinc-500 focus:outline-none text-xs text-white placeholder:text-zinc-600 transition-colors"
                    />
                    <div className="flex flex-wrap gap-1.5 mt-2">
                      {["B2B SaaS", "Fitness & Wellness", "Creator Coaching", "E-Commerce", "Finance"].map((tag) => (
                        <button
                          ...
                          className="px-2 py-0.5 rounded-md bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-[10px] text-zinc-300 hover:text-white transition-colors cursor-pointer"
                        >
                          {tag}
                        </button>
                      ))}
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full px-3.5 py-2.5 rounded-xl bg-zinc-900 border border-zinc-800 focus:border-zinc-500 focus:outline-none text-xs text-white transition-colors cursor-pointer"
                  >
                  ...
                  {desiredOutcome === "Other (describe)" && (
                    ...
                    >
                      <input
                        ...
                        className="w-full px-3.5 py-2 rounded-xl bg-zinc-900 border border-zinc-800 focus:border-zinc-500 focus:outline-none text-xs text-white placeholder:text-zinc-600"
                      />
                    </motion.div>
                  )}
                </div>
                ...
                <div>
                  <label className="block text-[11px] font-bold text-zinc-400 uppercase tracking-wider mb-1.5 flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-mono text-zinc-400 font-semibold uppercase">Context layer</span>
                  </label>
                  <input
                    type="text"
                    value={keyUSP}
            ...
            <div className="lg:col-span-7 space-y-4">
              <div className="p-5 sm:p-6 rounded-2xl bg-[#0D0B14] border border-zinc-800 flex flex-col h-full min-h-[520px]">
                ...
                <div className="flex-1 relative mb-5">
                  <textarea
                    ...
                    rows={16}
                    className="w-full h-full min-h-[340px] p-4 rounded-xl bg-zinc-950 border border-zinc-800 focus:border-zinc-500 focus:outline-none text-xs sm:text-sm text-zinc-200 font-mono leading-relaxed resize-none selection:bg-zinc-800"
                    placeholder="Your assembled prompt will appear here..."
                  />

                  {isEditingCustom && (
                    <div className="absolute top-2 right-2 px-2 py-1 rounded bg-zinc-800 border border-zinc-700 text-[10px] font-bold text-white">
                      Manual Edit Active
                    </div>
                  )}
                </div>
                ...
                <div className="pt-2 border-t border-zinc-800 flex flex-col sm:flex-row items-center justify-between gap-3">
                  ...
                  <div className="flex items-center gap-3 w-full sm:w-auto">
                    <button
                      type="button"
                      onClick={handleCopy}
                      className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 text-xs font-bold text-zinc-300 hover:text-white transition-all cursor-pointer"
                    >
                      {copied ? (
                        <>
                    ...
                    <button
                      ...
                      className="flex-1 sm:flex-initial inline-flex items-center justify-center gap-2 px-6 py-2.5 rounded-xl bg-white hover:bg-zinc-200 text-black font-extrabold text-xs uppercase tracking-wider transition-all cursor-pointer group"
                    >
