...
const Hyperspeed: React.FC<HyperspeedProps> = ({ effectOptions = DEFAULT_EFFECT_OPTIONS, className = '', style }) => {
    ...
    class App {
      ...
      loadAssets() {
        ...
        return new Promise<void>(resolve => {
          ...
          searchImage.addEventListener('error', function () {
            manager.itemEnd('smaa-search');
          });
          ...
          areaImage.addEventListener('error', function () {
            manager.itemEnd('smaa-area');
          });
  ...
  return <div id="lights" ref={hyperspeed} className={className} style={style}></div>;
};
