...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(targetCanvas: HTMLCanvasElement) {
      ...
      let glCtx: any = targetCanvas.getContext('webgl2', params);
      const isWebGL2 = Boolean(glCtx);
      if (!isWebGL2) {
        glCtx = targetCanvas.getContext('webgl', params) || (targetCanvas.getContext('experimental-webgl', params as any) as any);
      }
      ...
      const halfFloatTexType = isWebGL2 ? (glCtx as WebGL2RenderingContext).HALF_FLOAT : halfFloat && halfFloat.HALF_FLOAT_OES;
      let formatRGBA: any;
      let formatRG: any;
      let formatR: any;
