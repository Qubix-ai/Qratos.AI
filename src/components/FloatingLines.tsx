...
export default function FloatingLines({
  ...
  // Determine active gradient stops from props
  const effectiveGradient: string[] | undefined = linesGradient && linesGradient.length > 0
    ? linesGradient
  ...
  useEffect(() => {
    ...
    const handlePointerMove = (event: PointerEvent | MouseEvent) => {
      ...
      if (parallax) {
        ...
        const offsetX = (x - centerX) / (rect.width || 1);
        const offsetY = -(y - centerY) / (rect.height || 1);
    ...
    JSON.stringify(effectiveGradient),
